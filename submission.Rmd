...
#### 2. Naive post-motion prediciton

We re-train the pre-motion model to predict whether the defense plays a man- or zone coverage scheme, but, in this step, we incorporate results from `r colorize("Robert hier du","orange")`

#### 3. Post-motion prediction using a hidden Markov model
...
Entropy is a measure of uncertainty or randomness in a probability distribution, here, the empirical distribution of the defenders guarding the respective offensive players. Higher entropy indicates greater unpredictability, while lower entropy signifies more predictability. While these four features are correlated, the models that we have chosen are able to cope with the problem of multicollinearity. 
...
<center>
  <img src="coverage.gif" width="500" height="500" alt="Coverage Prediction">
</center>
